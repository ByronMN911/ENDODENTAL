...
Autor: Mathew Lara
Fecha: 05/12/2025
Versión: 3.1 (Con Validación de Negativos)
=============================================================================
-->
...
<%
    ...
    // Feedback
    String error = (String) request.getAttribute("error"); // Mensaje del Servlet (Ej: Precio negativo)
    String exitoParam = request.getParameter("exito"); // Mensaje de éxito

    // Objeto para editar
    Producto prodEdit = (Producto) request.getAttribute("productoEditar");

    int idVal = 0;
    String nombreVal = "", marcaVal = "", descVal = "";
    String precioVal = "", stockVal = "", stockMinVal = "";
                ...
                <form id="formProducto" action="inventario" method="POST">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <!-- VALIDACIÓN HTML5: min="0.01" y step="0.01" -->
                            <input type="number" step="0.01" min="0.01" name="precio_venta" id="precio" class="form-control form-control-custom"
                                   required placeholder="0.00" value="<%= precioVal %>">
                        </div>

                        <div class="col-md-4">
                            <label class="form-label-custom">Stock Inicial</label>
                            <!-- VALIDACIÓN HTML5: min="0" -->
                            <input type="number" min="0" name="stock" id="stock" class="form-control form-control-custom"
                        ...
                        <div class="col-md-4">
                            ...
                            <!-- VALIDACIÓN HTML5: min="0" -->
                            <input type="number" min="0" name="stock_minimo" id="stockMinimo" class="form-control form-control-custom"
